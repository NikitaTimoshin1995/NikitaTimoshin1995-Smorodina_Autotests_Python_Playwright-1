...
class TestClientBasketBuy:

#Баг когда группа на 4, выбрал 2 уч, создалось два подзаказа
...
#Добавить проверку уменьшения свободных мест, как будет сделана
    ...
    @allure.title('Покупка персонального тура')
    ...
    @allure.title('Покупка группового тура')
    def test_client_basket_buy2(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
        ...
        clientbasket.click_element('Кнопка Принять в датапикере в карточке тура клиента')
        page.wait_for_timeout(500)
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE3)
        assertions.check_field_value_from_locator('Количество участников кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_GROUP_AMOUNT1)
        assertions.check_data_datapicker_tourcard(C_CLIENT_TOUR_CARD_DATAPICKER_DATE2)
        clientbasket.click_element('Выбор участников в карточке тура клиента')
        assertions.check_data_participants_amount_tourcard_group(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME_GROUP,
                                                               C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_AMOUNT_GROUP )
        clientbasket.add_passengers_to_tourcard_group(2)
        assertions.check_data_participants_amount_tourcard_group(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME_GROUP, '3')
        clientbasket.click_element('Выбор участников в карточке тура клиента')
        page.wait_for_timeout(500)
        assertions.check_number_participants_rolled('3 чел')
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE4)
        assertions.check_field_value_from_locator('Количество участников кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_GROUP_AMOUNT1)
        clientbasket.click_element('Кнопка Купить в карточке тура клиента')
        clientbasket.click_element('Кнопка Корзина у авторизованного пользователя из тура')
        page.wait_for_timeout(1500)
    ...
    @allure.title('Покупка персонального тура с опциями')
    def test_client_basket_buy3(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового тура с опциями')
    def test_client_basket_buy4(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка персонального тура c промокодом1')
    def test_client_basket_buy5(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка персонального тура c промокодом2')
    def test_client_basket_buy6(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка персонального тура c сменой количества уч.')
    def test_client_basket_buy7(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
        ...
        assertions.check_data_participants_amount_tourcard('1','0','0','0','0')
        clientbasket.add_passengers_to_tourcard(1,2,2,2,2)
        assertions.check_data_participants_amount_tourcard('2','2','2','2','2')
        clientbasket.click_element('Выбор участников в карточке тура клиента')
        page.wait_for_timeout(500)
        assertions.check_number_participants_rolled('10 чел')
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE5)
        clientbasket.click_element('Кнопка Купить в карточке тура клиента')
        clientbasket.click_element('Кнопка Корзина у авторизованного пользователя из тура')
        page.wait_for_timeout(1500)
        assertions.check_basket_tour1_deployed(CLIENT_BASKET_TOUR1_TITLE,
    ...
    @allure.title('Покупка персонального тура с опциями c с промокодом1')
    def test_client_basket_buy8(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка персонального тура с опциями c с промокодом2')
    def test_client_basket_buy9(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка персонального тура с комментарием')
    def test_client_basket_buy10(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового тура с промокодом1')
    def test_client_basket_buy11(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового тура с промокодом2')
    def test_client_basket_buy12(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового c изменением количества уч.')
    def test_client_basket_buy13(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового тура с опциями с промокодом1')
    def test_client_basket_buy14(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового тура с опциями с промокодом2')
    def test_client_basket_buy15(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка группового тура с комментарием')
    def test_client_basket_buy16(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Неавторизованный пользователь. Покупка персонального') #Не будет возможности скорее всего
    def test_client_basket_buy17(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page)
        ...
        tour.change_product_booking(db_connection, CLIENT_BASKET_TOUR1_TITLE, False)
        clientbasket.open_page(CLIENT_BASKET_TOUR1_BUY_A) 
        assertions.check_data_datapicker_tourcard_no_auth(C_CLIENT_TOUR_CARD_DATAPICKER_DATE1_NOTIME)
        assertions.check_number_participants_rolled_no_auth('1 чел')
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента неавторизован', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE1)
        clientbasket.click_element_by_class_part('_datepicker')
        page.wait_for_timeout(1000)
        clientbasket.click_element('Первая дата тура1 в карточке тура клиента неавторизован')
        clientbasket.click_element('Кнопка Принять в датапикере в карточке тура клиента неавторизован')
        page.wait_for_timeout(500)
        assertions.check_data_datapicker_tourcard_no_auth(C_CLIENT_TOUR_CARD_DATAPICKER_DATE1)
        clientbasket.click_element('Выбор участников в карточке тура клиента неавторизован')
        assertions.check_data_participants_ages_tourcard_no_auth(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME1,
                                                         C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_PRICE1,
                                                         C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_AGES1,
                                                         C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME2,
                                                         C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_PRICE2,
        ...
        assertions.check_data_participants_amount_tourcard_no_auth('1','0','0','0','0')
        clientbasket.add_passengers_to_tourcard_no_auth(0,2,3,4,5)
        assertions.check_data_participants_amount_tourcard_no_auth('1','2','3','4','5')
        clientbasket.click_element('Выбор участников в карточке тура клиента неавторизован')
        page.wait_for_timeout(500)
        assertions.check_number_participants_rolled_no_auth('15 чел')
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента неавторизован', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE2)
        clientbasket.click_element('Кнопка Купить в карточке тура клиента неавторизован')
    ...
    @allure.title('Неавторизованный пользователь. Покупка группового') #Не будет возможности скорее всего
    def test_client_basket_buy18(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) 
        assertions_summary = AssertionsSellerSummary(page) 
        ...
        clientbasket.click_element_by_class_part('_datepicker')
        page.wait_for_timeout(1000)
        clientbasket.click_element('Вторая дата тура2 в карточке тура клиента неавторизован')
        clientbasket.click_element('Кнопка Принять в датапикере в карточке тура клиента неавторизован')
        page.wait_for_timeout(500)
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента неавторизован', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE3)
        assertions.check_field_value_from_locator('Количество участников кнопки Купить в карточке тура клиента неавторизован', C_CLIENT_TOUR_CARD_GROUP_AMOUNT1)
        assertions.check_data_datapicker_tourcard_no_auth(C_CLIENT_TOUR_CARD_DATAPICKER_DATE2)
        clientbasket.click_element('Выбор участников в карточке тура клиента неавторизован')
        assertions.check_data_participants_amount_tourcard_group_no_auth(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME_GROUP,
                                                               C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_AMOUNT_GROUP )
        clientbasket.add_passengers_to_tourcard_group_no_auth(2)
        assertions.check_data_participants_amount_tourcard_group_no_auth(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME_GROUP, '3')
        clientbasket.click_element('Выбор участников в карточке тура клиента неавторизован')
        page.wait_for_timeout(500)
        assertions.check_number_participants_rolled_no_auth('3 чел')
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента неавторизован', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE4)
        assertions.check_field_value_from_locator('Количество участников кнопки Купить в карточке тура клиента неавторизован', C_CLIENT_TOUR_CARD_GROUP_AMOUNT1)
        clientbasket.click_element('Кнопка Купить в карточке тура клиента неавторизован')
        clientbasket.client_auth_tour_card(db_connection,CLIENT_PHONE1)
        assertions.check_basket_tour1_deployed(CLIENT_BASKET_TOUR1_TITLE,
    ...
    @allure.title('Неавторизованный пользователь. Вход в корзине. Покупка персонального') #Не будет возможности скорее всего
    def test_client_basket_buy19(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
        ...
        clientbasket.click_element('кнопка Профиль>Профиль у клиента')
        clientbasket.click_element('кнопка Выйти')
        page.wait_for_timeout(2000)
    ...
    @allure.title('Неавторизованный пользователь. Вход в корзине. Покупка группового') #Не будет возможности скорее всего
    def test_client_basket_buy20(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Смена дат в корзине. Из персональной в групповую')
    def test_client_basket_buy21(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Смена дат в корзине. Из группового в персональный')
    def test_client_basket_buy22(self, page: Page, db_connection ):  
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
    ...
    @allure.title('Покупка персонального тура с выбором времени в карточке тура')
    def test_client_basket_buy23(self, page: Page, db_connection ):  
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
        ...
        clientbasket.click_element_by_class_part('_datepicker')
        page.wait_for_timeout(1000)
        clientbasket.click_element('Четвертая дата тура1 в карточке тура клиента')
        page.wait_for_timeout(500)
        clientbasket.click_element('Время4 тура1 в карточке тура клиента')
        page.wait_for_timeout(500)
        clientbasket.click_element('Кнопка Принять в датапикере в карточке тура клиента с временем')
        page.wait_for_timeout(1000)
        assertions.check_data_datapicker_tourcard(C_CLIENT_TOUR_CARD_DATAPICKER_DATE3)
        clientbasket.click_element('Выбор участников в карточке тура клиента')
        assertions.check_data_participants_ages_tourcard(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME1,
                                                         C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_PRICE1,
                                                         C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_AGES1,
    ...
    @allure.title('Покупка группового тура с выбором времени в карточке тура')
    def test_client_basket_buy24(self, page: Page, db_connection ): 
        assertions = AssertionsClientBasket(page) 
        clientbasket = ClientBasket(page) 
        seller_auth = SellerAuthRegistration(page) #Можно будет поменять на SellerSummary, если методы там появятся 
        assertions_summary = AssertionsSellerSummary(page)
        ...
        clientbasket.click_element_by_class_part('_datepicker')
        page.wait_for_timeout(1000)
        clientbasket.click_element('Пятая дата тура1 в карточке тура клиента')
        page.wait_for_timeout(500)
        clientbasket.click_element('Время4 тура1 в карточке тура клиента')
        page.wait_for_timeout(500)
        clientbasket.click_element('Кнопка Принять в датапикере в карточке тура клиента с временем')
        page.wait_for_timeout(500)
        assertions.check_field_value_from_locator('Цена кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_PRICE_BUTTON_VALUE6)
        assertions.check_field_value_from_locator('Количество участников кнопки Купить в карточке тура клиента', C_CLIENT_TOUR_CARD_GROUP_AMOUNT1)
        assertions.check_data_datapicker_tourcard(C_CLIENT_TOUR_CARD_DATAPICKER_DATE4)
        clientbasket.click_element('Выбор участников в карточке тура клиента')
        assertions.check_data_participants_amount_tourcard_group(C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_NAME_GROUP,
                                                               C_CLIENT_TOUR_CARD_SELECT_PARTICIPANTS_AMOUNT_GROUP )
        clientbasket.add_passengers_to_tourcard_group(2)
