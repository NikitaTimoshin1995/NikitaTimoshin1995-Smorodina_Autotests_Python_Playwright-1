...
# Настройки>Компании
SELLER_BUTTON_SETTINGS = '/html/body/div/ion-app/ion-router-outlet/div/div/div[2]/div[7]' # Настройки в меню продавца
SELLER_BUTTON_SETTINGS_COMPANY = '/html/body/div/ion-app/ion-popover/div/div/div[1]' # Настройки>Компания в меню продавца
SELLER_COMPANY_FORM = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[1]/div[2]/div/span' # Правовая форма
SELLER_INPUT_COMPANY_FACTADDRESS = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[2]/div/div[2]/div[2]/input' # Факт. адрес
SELLER_INPUT_COMPANY_PHONE = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[2]/div/div[3]/div[2]/input' # Телефон
SELLER_INPUT_COMPANY_EMAIL = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[2]/div/div[4]/div[2]/input' # E-mail
SELLER_BUTTON_SETTINGS_COMPANY_SAVE = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/div/div[1]/div[2]/button' # кнопка Сохранить
# Юр.лицо
SELLER_INPUT_COMPANY_LEGAL_INN = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[1]/div[2]/div/span' # ИНН
SELLER_INPUT__COMPANY_LEGAL_OPF = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[3]/div[2]/div/input' # ОПФ
SELLER_INPUT__COMPANY_LEGAL_FULLNAME = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[4]/div[2]/div/input' # Полное наименование
SELLER_INPUT__COMPANY_LEGAL_SHORTNAME = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[5]/div[2]/div[1]/input' # Краткое наименование
SELLER_INPUT__COMPANY_LEGAL_LEGADDRESS = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[6]/div[2]/div/input' # Юр. адрес
SELLER_INPUT__COMPANY_LEGAL_KPP = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[7]/div[2]/div/input' # КПП
SELLER_INPUT__COMPANY_LEGAL_OGRN = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[8]/div[2]/div/input' # ОГРН
SELLER_INPUT__COMPANY_LEGAL_BILL = '/html/body/div/ion-app/ion-router-outlet/div/ion-router-outlet/ion-content/div/form/div[1]/div[9]/div[2]/div/input' # Р. / счёт
...
LOCATORS = {
    ...
    # Настройки>Компании
    'кнопка Настройки в меню продавца': SELLER_BUTTON_SETTINGS,
    'кнопка компания в меню продавца': SELLER_BUTTON_SETTINGS_COMPANY,
    'Правовая форма': SELLER_COMPANY_FORM,
    'Факт. адрес': SELLER_INPUT_COMPANY_FACTADDRESS,
    'Телефон': SELLER_INPUT_COMPANY_PHONE,
    'E-mail': SELLER_INPUT_COMPANY_EMAIL,
    'кнопка Сохранить': SELLER_BUTTON_SETTINGS_COMPANY_SAVE,
    # Юр.лицо
    'ИНН': SELLER_INPUT_COMPANY_LEGAL_INN,
    'ОПФ': SELLER_INPUT__COMPANY_LEGAL_OPF,
    'Полное наименование': SELLER_INPUT__COMPANY_LEGAL_FULLNAME,
    'Краткое наименование': SELLER_INPUT__COMPANY_LEGAL_SHORTNAME,
    'Юр. адрес': SELLER_INPUT__COMPANY_LEGAL_LEGADDRESS,
    'КПП': SELLER_INPUT__COMPANY_LEGAL_KPP,
    'ОГРН': SELLER_INPUT__COMPANY_LEGAL_OGRN,
    'Р. / счёт': SELLER_INPUT__COMPANY_LEGAL_BILL,
    'БИК': SELLER_INPUT__COMPANY_LEGAL_BIC,
    'Банк': SELLER_INPUT__COMPANY_LEGAL_BANK,
    'ФИО ген. директора': SELLER_INPUT__COMPANY_LEGAL_DIRECTOR
